...
vim.keymap.set('n', 'N', 'Nzzzv')
-- end ThePrimeagen's bindings

-- Set to true if you have a Nerd Font installe
...
vim.keymap.set('n', '<leader>p', vim.diagnostic.goto_next, { desc = 'Go to next [D]iagnostic message' })
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      vim.g.blameLineGitFormat = '     ... %an - %s'
      vim.keymap.set('n', '<leader>b', ':ToggleBlameLine<CR>', { desc = 'Toggle [B]lame Line' })
    end,
  },
  {
